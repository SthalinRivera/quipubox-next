...
export default function UserDropdown() {
  ...
  const { profile } = useProfile(); // para datos extras como avatar_url
  ...
  const userAvatar = profile?.avatar_url || "/images/user/default-avatar.jpg"; // o un placeholder

  // Manejo de cierre de sesión
  const handleLogout = async () => {
    await logout();
    // después del logout, redirigir a login (ya lo hace el hook, pero por si acaso)
  };
